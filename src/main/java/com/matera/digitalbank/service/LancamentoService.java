...
import com.matera.digitalbank.entity.Transferencia;
...
import com.matera.digitalbank.repository.EstornoRepository;
import com.matera.digitalbank.repository.LancamentoRepository;
import com.matera.digitalbank.repository.TransferenciaRepository;
...
public class LancamentoService {
	...
	public void removeLancamentoEstorno(Long idConta, Long idLancamento) {
		...
		lancamentoOriginal.getConta()
				.setSaldo(DigitalBankUtils.calculaSaldo(Natureza.buscaPorCodigo(lancamentoOriginal.getNatureza()),
						lancamentoOriginal.getValor(), lancamentoOriginal.getConta().getSaldo()));
